...
def create():
    ...
    firstname = input("Please enter the customer's first name: ")#Get first name
    lastname = input("Please enter the customer's last name: ")#Get last name
...
def update():
    ...
    for line in customer:
        ...
        if len(parts) >= 2 and parts[1].title() == search:#Match last name
            ...
            firstname = input("Enter new first name: ")#Get updated info
